...
// export default function WeatherCard({ weatherInfo, forecastInfo, isFavorite, onToggleFavorite }) {
...
//             }
//             const labels = forecastInfo.map(label => label.date)
//             const windSpeedData = forecastInfo.map(wind => wind.windSpeed)
//             const windGustData = forecastInfo.map(speed => speed.gust || 0)
...
//                             x: {
//                             ticks: {
//                                 font: { size: 12, weight: 'bold' }, // bigger x-axis labels
//                                 maxRotation: 0,
//                                 minRotation: 0,
//                             },
//                             },
//                             y: {
//                             ticks: {
//                                 font: { size: 12, weight: 'bold' }, // bigger y-axis numbers
//                             },
//                             },
//                         },
//                         plugins: {
//                             legend: {
//                             labels: {
//                                 font: { size: 12, weight: 'bold' }, // bigger legend
//                             },
//                             },
//                             tooltip: {
//                             bodyFont: { size: 12 }, // bigger tooltip numbers
...
//             </div>
// {/* CHART */}
//             <div className="max-w-3xl mx-auto p-4 bg-white rounded shadow mt-8 mb-20">
...
//                     <canvas 
//                         ref={canvasRef} 
//                         style={{ width: `${forecastInfo.length * 60}px`, height: '755px'}}
//                     />
//                 </div>
//             </div>
// {/* END CHART */}
